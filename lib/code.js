...
(function (EasyCheers) {
    ...
    (function (tools) {
        class CoinTool {
            ...
            static guess(contractHash, address, min, max, odds) {
                return __awaiter(this, void 0, void 0, function* () {
                    console.log(address);
                    var sb = new ThinNeo.ScriptBuilder();
                    var scriptaddress = contractHash.hexToBytes().reverse();
                    ...
                    sb.EmitPushNumber(random_int);
                    sb.Emit(ThinNeo.OpCode.DROP);
                    sb.EmitParamJson(["(address)" + address, "(integer)" + min, "(integer)" + max, "(integer)" + odds]);
...
(function (EasyCheers) {
    class SDK {
        ...
        static guess(contractHash, address, min, max, val, callback = null) {
            return __awaiter(this, void 0, void 0, function* () {
                if (SDK.is_init === false) {
                    console.log("[Easy]", '[SDK]', 'You have to call function init first');
                    return;
                ...
                let res = yield EasyCheers.tools.CoinTool.guess(contractHash, address, intMin, intMax, intVal);
                if (callback != null)
                    callback(JSON.stringify(res));
            });
        }
